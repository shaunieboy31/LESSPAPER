...
import AddDocTypeModal from 'modals/doc-types/AddDocTypeModal';
import UpdateDocTypeModal from 'modals/doc-types/UpdateDocTypeModal';
import useAxiosPrivate from 'contexts/interceptors/axios';

import { IoDocumentTextSharp } from 'react-icons/io5';

import PageTemplate from 'layouts/PageTemplate';
import DocTypesTable from './DocTypesTable';
    ...
    <PageTemplate
      ...
      modals={[
        ...
        <UpdateDocTypeModal
          ...
          data={selectedDocType && selectedDocType[0]}
          updateTableFunction={handleGetAll}
        />
      ]}
      error={error}
