...
export default function AddDocTypeModal({ open, handleClose, updateTableFunction }) {
  ...
  const formik = useFormik({
    ...
    onSubmit: () => {
      ...
      axiosPrivate
        .post('/libraries/addDocType', formik.values)
        .then(() => {
          enqueueSnackbar('Document Type Added', {
            variant: 'success'
          });
          updateTableFunction();
          formik.resetForm();
