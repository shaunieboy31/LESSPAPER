...
export default function UpdateUnitModal({ open, handleClose, data, updateTableFunction }) {
  ...
  const formik = useFormik({
    ...
    onSubmit: () => {
      ...
      axiosPrivate
        .put(`/libraries/updateUnit/${data?.id}`, formik.values)
        .then(() => {
  ...
  useEffect(() => {
    setDisabled(!formik.values.unit);
  }, [formik.values]);
