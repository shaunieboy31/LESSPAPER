...
export default function UpdateSystemModal({ open, handleClose, data, updateTableFunction }) {
  ...
  const formik = useFormik({
    ...
    onSubmit: () => {
      ...
      axiosPrivate
        .put(`/libraries/updateSystem/${data?.id}`, formik.values)
        .then(() => {
          enqueueSnackbar('System Updated', {
            variant: 'success'
          });
          updateTableFunction();
          handleClose();
