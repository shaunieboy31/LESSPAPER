...
export default function SelectDivision({
  ...
  const handleGetAll = () => {
    ...
    axiosPrivate
      ...
      .then((e) => {
        const fetchedDesignations = e?.data;

        setDivisions(fetchedDesignations);
      })
      .catch((err) => {
  ...
  const [selectedDivision, setSelectedDivision] = useState(
    divisions?.find((division) => division.id === value) || null
  );
  ...
  return (
    <Box>
      <TextField
        ...
        value={selectedDivision && value ? selectedDivision.name : ""}
        onClick={handleClick}
        onBlur={onBlur}
        error={errorFormik}
